...
// Принимает в качестве аргументов указатель на очередь роутеров по значению, экземпляр структуры роутера по значению. 
// Выделяет память динамически для нового элемента. 
// Устанавливаются новые значения указателей головы очереди, next, prev 
